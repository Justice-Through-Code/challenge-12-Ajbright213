...
my_library.add_title('The Body Keeps the Score', 'Brddrl van der Kolk')
...
nyt_bestsellers.add_title("The Cat In The Hat", 'Dr. Seusse')
nyt_bestsellers.add_title("The Cat", 'Dr. Eusse')
